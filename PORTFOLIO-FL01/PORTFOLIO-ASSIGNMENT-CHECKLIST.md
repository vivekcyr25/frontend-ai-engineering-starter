# Portfolio / AI Fluency Week 1 Assignment Checklist

This checklist tracks all deliverables and setup steps required for **Week 1: Portfolio Architecture, AI Workspace Configuration & Pressure Testing**.

---

## Part A: Deliverables Prepared by AI Assistant (Ready in Repository)

- [x] **Repository Structure Initialized:** `PORTFOLIO-FL01/` folder created with standard deliverables layout.
- [x] **Portfolio Sitemap Created:** Documented in [`portfolio-sitemap.md`](file:///c:/Users/hp/Desktop/FL-01/PORTFOLIO-FL01/portfolio-sitemap.md) with proof statement, primary CTA, and page details.
- [x] **Visual / Printable Sitemap Created:** Generated in [`portfolio-sitemap.html`](file:///c:/Users/hp/Desktop/FL-01/PORTFOLIO-FL01/portfolio-sitemap.html) for visual review and PDF/print export.
- [x] **Claude Project Instructions Formatted:** Custom instructions ready in [`claude-project-instructions.md`](file:///c:/Users/hp/Desktop/FL-01/PORTFOLIO-FL01/claude-project-instructions.md) with tutor persona and proof constraints.
- [x] **Pressure-Test Prompt Prepared:** Exact prompt defined in [`claude-pressure-test-prompt.md`](file:///c:/Users/hp/Desktop/FL-01/PORTFOLIO-FL01/claude-pressure-test-prompt.md).
- [x] **Pressure-Test Response Template Created:** Structured template in [`claude-pressure-test-response.md`](file:///c:/Users/hp/Desktop/FL-01/PORTFOLIO-FL01/claude-pressure-test-response.md) awaiting real execution.
- [x] **Evidence Folder Created:** Located at `PORTFOLIO-FL01/evidence/` with placeholder guidelines.
...
## Part C: Evidence Files Checklist

Place all captured image files in the `PORTFOLIO-FL01/evidence/` directory:

| Filename | Description | Status |
| :--- | :--- | :--- |
| `sitemap-photo.png` | Photo of hand-drawn / whiteboard sitemap sketch | [ ] Pending Manual Capture |
| `claude-project.png` | Screenshot of Claude Project configuration and instructions | [ ] Pending Manual Capture |
| `claude-pressure-test.png` | Screenshot of Claude pressure-test prompt and output | [ ] Pending Manual Capture |
